...
UserHook.setDefaults = async (userInstance) => {
  ...
  userInstance.verified = (userInstance.provider === 'local' ? ( Env.get('APP_SUPERADMIN_EMAIL', null) !== null && userInstance.email === Env.get('APP_SUPERADMIN_EMAIL') ) ? true : false : true)
}
